...
#C Forecast allocations based on dead biomass (total removals)
#C all fleets (except shrimp trawl 13 and 14) assigned to an allocation group
###################################################
...
# Bmark_years
#	NOTE THAT I AM CHOSING 1984-2016 WHICH MIGHT BE DIFFERENT FROM SEDAR52
